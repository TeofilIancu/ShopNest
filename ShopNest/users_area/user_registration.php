                ...
                <div class="col-lg-12 col-xl-6">
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-outline mb-4">
                            ...
                            <input type="password" id="conf_user_password" class="form-control" placeholder="Re-Enter your password" autocomplete="off" required="required" name="conf_user_password">
                        </div>
